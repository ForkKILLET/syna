import type { Awaitable, Binding, CandidateRef, Contract, Dependency, EntryDescriptor, Input, ServiceRevision } from '../descriptors.js';
import type { LabeledGraphNode } from '../graph.js';
export type EnvState = 'activating' | 'ready' | 'disposing' | 'disposed';
export type ServiceSlotState = 'dormant' | 'starting' | 'ready' | 'failed' | 'disposing' | 'disposed';
...
export type PlanNode = ServicePlanNode | InputPlanNode | BindingPlanNode | SelectorPlanNode | AllPlanNode | BoundEntryPlanNode;
...
export declare class NeedChoice extends Error {
