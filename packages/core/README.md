...
Full documentation lives in the source workspace (not in this package): `docs/API_REFERENCE.md`, `docs/API_STABILITY.md`, `docs/MIGRATION_V07_TO_V08.md`, `docs/GLOSSARY.md`, `docs/MIGRATION_V06_TO_V07.md`, `docs/SEMANTIC_CHANGES_V07.md`, `docs/MIGRATION_V05_TO_V06.md`, `docs/SEMANTIC_MODEL.md`, `docs/SEMANTIC_CHANGES_V05.md` and `docs/MIGRATION_V04_TO_V05.md` of the Syna source repository, https://github.com/synajs/syna (the `docs/` directory of its source archive). The package ships `dist/` only; its type declarations carry no `@deprecated` item, and its public surface is frozen from 0.8.0, the last rename before 1.0 (`docs/API_STABILITY.md`). Node ≥ 22.
