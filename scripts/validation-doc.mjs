...
const diffText = diffSummary ? `${diffSummary[1]} items in the 0.8.0 record, ${diffSummary[2]} here: ${diffSummary[3]} added, ${diffSummary[4]} removed, ${diffSummary[5]} changed in signature, ${diffSummary[6]} changed in JSDoc only, ${diffSummary[7]} newly deprecated` : 'no diff recorded'
