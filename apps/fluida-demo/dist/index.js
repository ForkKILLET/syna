...
import { ArticleRepository, DatabaseEntry, Transaction, TransactionEntry, } from '@syna-demo/fluida';
...
const executeTransaction = async (id) => databaseEnv.run(TransactionEntry, { transaction: { id, mode: 'write' } }, async ({ transaction, articles }, env) => {
...
console.log('Both transactions share the same pool:', first.tx.databasePool === second.tx.databasePool
