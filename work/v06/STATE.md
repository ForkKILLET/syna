...
- Run 6 (commit f019402, the source that contains that VALIDATION.md; the final evidence run, committed as the last commit): **COMPLETE**, 782 test executions (391 distinct, 391 re-run in the rebuilt copy), 782 passed, 0 failed steps, 0 skipped; source fingerprint `c7a83b6adec8b45eee5c7b709cd67f2c05397f62602d41373a47837f1db9fa2c` (333 files); same-session comparison 23/23 within ±10 % (largest delta −3.0 %), 116/116 counters equal, record drift (informational) 19/23; `any` count within the shipped baseline; consumer smoke `{"result":84,"revision":"7.3.1","explainOk":true,"missing":"smoke.consumer/input/answer/v1"}`; PostgreSQL 17.10 temporary cluster; provenance `modified: []`, `untracked: [the two task documents]`. Archives of this run (`work/release/`, gitignored; hashes also in `validation/v0.6-release/SHA256SUMS.txt`):
  - `work/release/syna-v0.6.0-source.tar.gz` 663178 bytes sha256 `1a0a007d27e768536362d9bdb6280eba186b4f6f2fb9868b78e72e0ae6d5a06c`
  - `work/release/syna-v0.6.0-source.zip` 845077 bytes sha256 `387165f6b56dd578eae9a459d2977522a7096c5eac00a87d612010a43c033fde`
...
Nothing has been pushed; the v0.6 commits sit on local `main` on top of the pushed v0.5 history.
