...
## Current phase
Third review round: fixes committed (A–F), independent re-audit of the round done and every finding closed (fixed with a regression, or recorded as a documented limit) → see "Third review round" below; the release runs of this round are recorded in "Release gate after the third review round" once they exist.
